 ...
 * @generated
 */
public class SmartcontractSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SmartcontractPackage.SMART_CONTRACTS: {
				SmartContracts smartContracts = (SmartContracts)theEObject;
				T result = caseSmartContracts(smartContracts);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SmartcontractPackage.SMART_CONTRACT: {
				SmartContract smartContract = (SmartContract)theEObject;
				T result = caseSmartContract(smartContract);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SmartcontractPackage.CONTRACT_FUNCTION: {
				ContractFunction contractFunction = (ContractFunction)theEObject;
				T result = caseContractFunction(contractFunction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SmartcontractPackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SmartcontractPackage.INPUT_PARAMETER: {
			...
			case SmartcontractPackage.OUTPUT_PARAMETER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Smart Contracts</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Smart Contracts</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSmartContracts(SmartContracts object) {
		return null;
	}
