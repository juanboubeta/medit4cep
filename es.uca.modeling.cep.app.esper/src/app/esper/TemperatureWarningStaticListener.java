 ...
 */
public class TemperatureWarningStaticListener implements UpdateListener {
	
	private static Logger logger = Logger.getLogger(TemperatureWarningStaticListener.class);
