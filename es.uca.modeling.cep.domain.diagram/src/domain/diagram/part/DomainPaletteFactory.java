...
public class DomainPaletteFactory {
	...
	private ToolEntry createEvent1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Messages.Event1CreationTool_desc,
				Collections.singletonList(DomainElementTypes.Event_2001));
		entry.setId("createEvent1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DomainElementTypes
				.getImageDescriptor(DomainElementTypes.Event_2001));
	...
	private ToolEntry createEventProperty2CreationTool() {
		...
		entry.setSmallIcon(DomainElementTypes
				.getImageDescriptor(DomainElementTypes.EventProperty_3001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
