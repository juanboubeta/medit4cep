 ...
 * @generated
 */
public class EventPropertyNameTypeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public EventPropertyNameTypeEditPart(View view) {
		super(view);
	}
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(domain.diagram.edit.parts.EventPropertyNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
