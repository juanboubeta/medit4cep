...
/**
 * This is the item provider adapter for a {@link eventpattern.SmartContract} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SmartContractItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SmartContract_typeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SmartContract_typeName_feature", "_UI_SmartContract_type"),
				 EventpatternPackage.Literals.SMART_CONTRACT__TYPE_NAME,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EventpatternPackage.Literals.SMART_CONTRACT__CONTRACTFUNCTIONS);
			childrenFeatures.add(EventpatternPackage.Literals.SMART_CONTRACT__SMART_CONTRACT_PROPERTIES);
		}
	...
	public String getText(Object object) {
		String label = ((SmartContract)object).getTypeName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EventpatternPackage.Literals.SMART_CONTRACT__CONTRACTFUNCTIONS,
				 EventpatternFactory.eINSTANCE.createContractFunction()));

		newChildDescriptors.add
			(createChildParameter
				(EventpatternPackage.Literals.SMART_CONTRACT__SMART_CONTRACT_PROPERTIES,
				 EventpatternFactory.eINSTANCE.createContractFunction()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == EventpatternPackage.Literals.SMART_CONTRACT__CONTRACTFUNCTIONS ||
			childFeature == EventpatternPackage.Literals.SMART_CONTRACT__SMART_CONTRACT_PROPERTIES;
