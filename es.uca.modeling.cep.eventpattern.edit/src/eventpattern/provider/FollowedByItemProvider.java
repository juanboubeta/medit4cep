...
/**
 * This is the item provider adapter for a {@link eventpattern.FollowedBy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FollowedByItemProvider
  extends NaryOperatorItemProvider
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public FollowedByItemProvider(AdapterFactory adapterFactory)
  {
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FollowedBy"));
	}
  ...
  {
		return getString("_UI_FollowedBy_type");
	}
