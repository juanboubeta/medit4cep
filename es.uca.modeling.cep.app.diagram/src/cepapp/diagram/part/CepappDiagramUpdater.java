...
public class CepappDiagramUpdater {
	...
	*/
	public static List<CepappLinkDescriptor> getContainedLinks(View view) {
		...
		case InMemoryInputEditPart.VISUAL_ID:
			return getInMemoryInput_2011ContainedLinks(view);
		...
		case InMemoryOutputEditPart.VISUAL_ID:
			return getInMemoryOutput_2012ContainedLinks(view);
	...
	*/
	public static List<CepappLinkDescriptor> getIncomingLinks(View view) {
		switch (CepappVisualIDRegistry.getVisualID(view)) {
		case InMemoryInputEditPart.VISUAL_ID:
			return getInMemoryInput_2011IncomingLinks(view);
		case InputFileEditPart.VISUAL_ID:
			return getInputFile_2001IncomingLinks(view);
		case SourceMqttEditPart.VISUAL_ID:
			return getSourceMqtt_2004IncomingLinks(view);
		case InMemoryOutputEditPart.VISUAL_ID:
			return getInMemoryOutput_2012IncomingLinks(view);
		case OutputFileEditPart.VISUAL_ID:
	...
	*/
	public static List<CepappLinkDescriptor> getOutgoingLinks(View view) {
		switch (CepappVisualIDRegistry.getVisualID(view)) {
		case InMemoryInputEditPart.VISUAL_ID:
			return getInMemoryInput_2011OutgoingLinks(view);
		case InputFileEditPart.VISUAL_ID:
			return getInputFile_2001OutgoingLinks(view);
		case SourceMqttEditPart.VISUAL_ID:
			return getSourceMqtt_2004OutgoingLinks(view);
		case InMemoryOutputEditPart.VISUAL_ID:
			return getInMemoryOutput_2012OutgoingLinks(view);
		case OutputFileEditPart.VISUAL_ID:
	...
	* @generated
	*/
	public static List<CepappLinkDescriptor> getInMemoryInput_2011ContainedLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<CepappLinkDescriptor> getInMemoryOutput_2012ContainedLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<CepappLinkDescriptor> getInMemoryInput_2011IncomingLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<CepappLinkDescriptor> getInMemoryOutput_2012IncomingLinks(View view) {
	...
	* @generated
	*/
	public static List<CepappLinkDescriptor> getInMemoryInput_2011OutgoingLinks(View view) {
	...
	* @generated
	*/
	public static List<CepappLinkDescriptor> getInMemoryOutput_2012OutgoingLinks(View view) {
		return Collections.emptyList();
	}
