...
public class CepappVisualIDRegistry {
	...
	*/
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case CEPAppEditPart.VISUAL_ID:
			if (CepappPackage.eINSTANCE.getSinkMongoDB().isSuperTypeOf(domainElement.eClass())) {
				return SinkMongoDBEditPart.VISUAL_ID;
			}
			if (CepappPackage.eINSTANCE.getInMemoryInput().isSuperTypeOf(domainElement.eClass())) {
				return InMemoryInputEditPart.VISUAL_ID;
			}
			if (CepappPackage.eINSTANCE.getSourceEmail().isSuperTypeOf(domainElement.eClass())) {
				return SourceEmailEditPart.VISUAL_ID;
			}
			if (CepappPackage.eINSTANCE.getInputFile().isSuperTypeOf(domainElement.eClass())) {
				return InputFileEditPart.VISUAL_ID;
			}
			if (CepappPackage.eINSTANCE.getSourceHttp().isSuperTypeOf(domainElement.eClass())) {
				return SourceHttpEditPart.VISUAL_ID;
			}
			...
			if (CepappPackage.eINSTANCE.getSinkEmail().isSuperTypeOf(domainElement.eClass())) {
				return SinkEmailEditPart.VISUAL_ID;
			}
			if (CepappPackage.eINSTANCE.getOutputFile().isSuperTypeOf(domainElement.eClass())) {
				return OutputFileEditPart.VISUAL_ID;
			}
			if (CepappPackage.eINSTANCE.getSinkHttp().isSuperTypeOf(domainElement.eClass())) {
				return SinkHttpEditPart.VISUAL_ID;
			}
	...
	*/
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		switch (containerVisualID) {
		case CEPAppEditPart.VISUAL_ID:
			if (SinkMongoDBEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (InMemoryInputEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (SourceEmailEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (InputFileEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (SourceHttpEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			...
			if (SinkEmailEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (OutputFileEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (SinkHttpEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
