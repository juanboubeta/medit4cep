...
public class CepappElementTypes {
	...
	* @generated
	*/
	public static final IElementType InMemoryInput_2011 = getElementType(
			"es.uca.modeling.cep.app.diagram.InMemoryInput_2011"); //$NON-NLS-1$
	...
	* @generated
	*/
	public static final IElementType InMemoryOutput_2012 = getElementType(
			"es.uca.modeling.cep.app.diagram.InMemoryOutput_2012"); //$NON-NLS-1$
	...
	*/
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(InMemoryInput_2011, CepappPackage.eINSTANCE.getInMemoryInput());
			...
			elements.put(InMemoryOutput_2012, CepappPackage.eINSTANCE.getInMemoryOutput());
	...
	*/
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(InMemoryInput_2011);
			KNOWN_ELEMENT_TYPES.add(InputFile_2001);
			KNOWN_ELEMENT_TYPES.add(SourceMqtt_2004);
			KNOWN_ELEMENT_TYPES.add(InMemoryOutput_2012);
