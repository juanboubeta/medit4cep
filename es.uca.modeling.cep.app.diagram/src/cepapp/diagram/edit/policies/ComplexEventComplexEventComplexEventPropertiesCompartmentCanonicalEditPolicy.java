...
public class ComplexEventComplexEventComplexEventPropertiesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CepappPackage.eINSTANCE.getComplexEvent_ComplexEventProperties();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CepappNodeDescriptor> childDescriptors = CepappDiagramUpdater
				.getComplexEventComplexEventComplexEventPropertiesCompartment_7004SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ComplexEventPropertyEditPart.VISUAL_ID == CepappVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<CepappNodeDescriptor> childDescriptors = CepappDiagramUpdater
				.getComplexEventComplexEventComplexEventPropertiesCompartment_7004SemanticChildren(
