 ...
 * @generated
 */
public class ComplexEventPropertyComplexEventPropertyComplexEventPropertiesCompartment2CanonicalEditPolicy
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CepappPackage.eINSTANCE.getComplexEventProperty_ComplexEventProperties();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CepappNodeDescriptor> childDescriptors = CepappDiagramUpdater
				.getComplexEventPropertyComplexEventPropertyComplexEventPropertiesCompartment_7006SemanticChildren(
						viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ComplexEventProperty2EditPart.VISUAL_ID == CepappVisualIDRegistry.getVisualID(view);
	}
