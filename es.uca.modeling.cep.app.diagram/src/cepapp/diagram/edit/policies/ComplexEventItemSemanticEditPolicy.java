...
import cepapp.diagram.edit.commands.LinkCreateCommand;
import cepapp.diagram.edit.commands.LinkReorientCommand;
 ...
 * @generated
 */
public class ComplexEventItemSemanticEditPolicy extends CepappBaseItemSemanticEditPolicy {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (CepappVisualIDRegistry.getVisualID(outgoingLink) == LinkEditPart.VISUAL_ID) {
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (CepappElementTypes.Link_4001 == req.getElementType()) {
