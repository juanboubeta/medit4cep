...
public class EventPropertyName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CepappParserProvider.getParser(CepappElementTypes.EventProperty_3002, getParserElement(),
					CepappVisualIDRegistry.getType(cepapp.diagram.edit.parts.EventPropertyName2EditPart.VISUAL_ID));
		}
		return parser;
	}
