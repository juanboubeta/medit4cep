...
import cepapp.diagram.edit.policies.EventProperty2ItemSemanticEditPolicy;
...
public class EventProperty2EditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CepappVisualIDRegistry.getType(EventPropertyName2EditPart.VISUAL_ID));
	}
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CepappElementTypes.EventProperty_3002) {
