 ...
 * @generated
 */
public class ComplexEventPropertyNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ComplexEventPropertyNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CepappParserProvider.getParser(CepappElementTypes.ComplexEventProperty_3003, getParserElement(),
					CepappVisualIDRegistry
							.getType(cepapp.diagram.edit.parts.ComplexEventPropertyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
