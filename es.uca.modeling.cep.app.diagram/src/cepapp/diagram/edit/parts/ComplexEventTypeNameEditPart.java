 ...
 * @generated
 */
public class ComplexEventTypeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ComplexEventTypeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CepappParserProvider.getParser(CepappElementTypes.ComplexEvent_2010, getParserElement(),
					CepappVisualIDRegistry.getType(cepapp.diagram.edit.parts.ComplexEventTypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
