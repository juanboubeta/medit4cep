...
import cepapp.diagram.edit.policies.ComplexEventPropertyItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ComplexEventPropertyEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ComplexEventPropertyEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ComplexEventPropertyItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComplexEventPropertyNameEditPart) {
			((ComplexEventPropertyNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureComplexEventPropertyLabelFigure());
			return true;
		}
		if (childEditPart instanceof ComplexEventPropertyComplexEventPropertyComplexEventPropertiesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getComplexEventPropertyComplexEventPropertiesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ComplexEventPropertyComplexEventPropertyComplexEventPropertiesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComplexEventPropertyComplexEventPropertyComplexEventPropertiesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getComplexEventPropertyComplexEventPropertiesCompartmentFigure();
			pane.remove(
					((ComplexEventPropertyComplexEventPropertyComplexEventPropertiesCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ComplexEventPropertyComplexEventPropertyComplexEventPropertiesCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CepappVisualIDRegistry.getType(ComplexEventPropertyNameEditPart.VISUAL_ID));
	}
