...
import cepapp.diagram.edit.commands.CepappCreateShortcutDecorationsCommand;
import cepapp.diagram.edit.policies.CEPAppCanonicalEditPolicy;
import cepapp.diagram.edit.policies.CEPAppItemSemanticEditPolicy;
import cepapp.diagram.part.CepappVisualIDRegistry;

/**
 * @generated
 */
public class CEPAppEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "Cepapp"; //$NON-NLS-1$
	...
	* @generated
	*/
	public CEPAppEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CEPAppItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CEPAppCanonicalEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command
							.chain(new ICommandProxy(new CepappCreateShortcutDecorationsCommand(getEditingDomain(),
