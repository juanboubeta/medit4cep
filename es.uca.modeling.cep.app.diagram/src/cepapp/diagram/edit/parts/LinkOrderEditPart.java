...
import cepapp.diagram.edit.policies.CepappTextSelectionEditPolicy;
...
public class LinkOrderEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(CepappVisualIDRegistry.getType(cepapp.diagram.edit.parts.LinkOrderEditPart.VISUAL_ID),
				new Point(-10, -10));
	}
	...
	* @generated
	*/
	public LinkOrderEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new CepappTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CepappParserProvider.getParser(CepappElementTypes.Link_4001, getParserElement(),
					CepappVisualIDRegistry.getType(cepapp.diagram.edit.parts.LinkOrderEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, CepappEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new LinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class LinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LinkLabelFigure() {
			this.setText("Link");
		}
