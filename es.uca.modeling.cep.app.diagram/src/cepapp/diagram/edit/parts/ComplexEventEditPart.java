...
import cepapp.diagram.edit.policies.ComplexEventItemSemanticEditPolicy;
...
public class ComplexEventEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CepappVisualIDRegistry.getType(ComplexEventTypeNameEditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CepappElementTypes.ComplexEventProperty_3003) {
				return getChildBySemanticHint(CepappVisualIDRegistry
