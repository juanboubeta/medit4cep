 ...
 * @generated
 */
public class ComplexEventPropertyName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ComplexEventPropertyName2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return CepappElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CepappParserProvider.getParser(CepappElementTypes.ComplexEventProperty_3004, getParserElement(),
					CepappVisualIDRegistry
							.getType(cepapp.diagram.edit.parts.ComplexEventPropertyName2EditPart.VISUAL_ID));
		}
		return parser;
	}
