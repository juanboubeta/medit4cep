...
public class EventPropertyNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CepappParserProvider.getParser(CepappElementTypes.EventProperty_3001, getParserElement(),
					CepappVisualIDRegistry.getType(cepapp.diagram.edit.parts.EventPropertyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
