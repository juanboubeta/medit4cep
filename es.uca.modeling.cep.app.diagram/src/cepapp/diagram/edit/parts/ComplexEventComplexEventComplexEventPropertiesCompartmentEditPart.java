...
import cepapp.diagram.edit.policies.ComplexEventComplexEventComplexEventPropertiesCompartmentCanonicalEditPolicy;
import cepapp.diagram.edit.policies.ComplexEventComplexEventComplexEventPropertiesCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ComplexEventComplexEventComplexEventPropertiesCompartmentEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public ComplexEventComplexEventComplexEventPropertiesCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CepappElementTypes.ComplexEventProperty_3003) {
				return this;
			}
