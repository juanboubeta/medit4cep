...
public class DuplicateExistingPatternDialog extends TitleAreaDialog {
	  ...
	  public DuplicateExistingPatternDialog(Shell parentShell) {
	  ...
	  public void create() {
		  ...
		  super.create();
		  setTitle("Duplicate Existing Pattern");
