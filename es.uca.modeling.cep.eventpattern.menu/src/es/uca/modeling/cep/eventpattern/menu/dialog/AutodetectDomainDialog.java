...
public class AutodetectDomainDialog extends TitleAreaDialog {
	  ...
	  public AutodetectDomainDialog(Shell parentShell) {
	  ...
	  public void create() {
		  ...
		  super.create();
		  setTitle("Auto-detect domain");
		  setMessage("Please insert the information of the domain to be auto-detected:", 
