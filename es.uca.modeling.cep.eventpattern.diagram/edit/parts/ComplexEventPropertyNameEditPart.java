...
public class ComplexEventPropertyNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * of a ComplexEventProperty node, when the editor is loaded.
	 * @generated NOT
	 */
	protected Image getLabelIcon() {
		...
		if (eObject instanceof ComplexEventProperty) {
			imagePath = ((ComplexEventProperty) eObject).getImagePath();
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.ComplexEventProperty_3059,
					getParserElement(), EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.ComplexEventPropertyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
