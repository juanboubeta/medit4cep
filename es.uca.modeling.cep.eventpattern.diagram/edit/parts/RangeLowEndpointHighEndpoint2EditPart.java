 ...
 * @generated
 */
public class RangeLowEndpointHighEndpoint2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RangeLowEndpointHighEndpoint2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.Range_3021, getParserElement(),
					EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.RangeLowEndpointHighEndpoint2EditPart.VISUAL_ID));
		}
		return parser;
	}
