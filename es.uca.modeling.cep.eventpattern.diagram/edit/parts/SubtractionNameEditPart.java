 ...
 * @generated
 */
public class SubtractionNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SubtractionNameEditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.SubtractionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
