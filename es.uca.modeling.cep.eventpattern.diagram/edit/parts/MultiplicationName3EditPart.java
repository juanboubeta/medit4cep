 ...
 * @generated
 */
public class MultiplicationName3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MultiplicationName3EditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.MultiplicationName3EditPart.VISUAL_ID));
		}
		return parser;
	}
