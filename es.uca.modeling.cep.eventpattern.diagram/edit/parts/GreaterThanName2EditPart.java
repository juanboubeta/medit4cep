 ...
 * @generated
 */
public class GreaterThanName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GreaterThanName2EditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.GreaterThanName2EditPart.VISUAL_ID));
		}
		return parser;
	}
