 ...
 * @generated
 */
public class SlidingEventIntervalSizeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SlidingEventIntervalSizeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.SlidingEventInterval_2034,
					getParserElement(), EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.SlidingEventIntervalSizeEditPart.VISUAL_ID));
		}
		return parser;
	}
