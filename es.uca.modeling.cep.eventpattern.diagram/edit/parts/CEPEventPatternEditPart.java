...
import eventpattern.diagram.edit.commands.EventpatternCreateShortcutDecorationsCommand;
import eventpattern.diagram.edit.policies.CEPEventPatternCanonicalEditPolicy;
import eventpattern.diagram.edit.policies.CEPEventPatternItemSemanticEditPolicy;
import eventpattern.diagram.part.EventpatternVisualIDRegistry;

/**
 * @generated
 */
public class CEPEventPatternEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "Eventpattern"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public CEPEventPatternEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CEPEventPatternItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CEPEventPatternCanonicalEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(new EventpatternCreateShortcutDecorationsCommand(
