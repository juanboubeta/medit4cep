 ...
 * @generated
 */
public class LessEqualNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LessEqualNameEditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.LessEqualNameEditPart.VISUAL_ID));
		}
		return parser;
	}
