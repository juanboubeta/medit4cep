...
public class EventpatternNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	public EventpatternNewDiagramFileWizard(URI domainModelURI,
		...
		myFileCreationPage = new WizardNewFileCreationPage(
				Messages.EventpatternNewDiagramFileWizard_CreationPageName,
				StructuredSelection.EMPTY);
		myFileCreationPage
				.setTitle(Messages.EventpatternNewDiagramFileWizard_CreationPageTitle);
		myFileCreationPage
				.setDescription(NLS
						.bind(Messages.EventpatternNewDiagramFileWizard_CreationPageDescription,
		...
		myFileCreationPage.setFileName(EventpatternDiagramEditorUtil
		...
		diagramRootElementSelectionPage
				.setTitle(Messages.EventpatternNewDiagramFileWizard_RootSelectionPageTitle);
		diagramRootElementSelectionPage
	...
	public boolean performFinish() {
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				myEditingDomain,
				Messages.EventpatternNewDiagramFileWizard_InitDiagramCommand,
				affectedFiles) {
	...
	private static class DiagramRootElementSelectionPage extends
		...
		protected boolean validatePage() {
			...
			setErrorMessage(result ? null
					: Messages.EventpatternNewDiagramFileWizard_RootSelectionPageInvalidSelectionMessage);
			return result;
		}
	}
}
