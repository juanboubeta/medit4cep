...
public class ValidateAction extends Action {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		EventpatternValidationProvider.runWithConstraints(txDomain,
				new Runnable() {
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			...
			View view = EventpatternDiagramEditorUtil.findView(diagramEditPart,
	...
	private static void createMarkers(IFile target,
		...
		for (Iterator it = emfValidationStatus.getChildren().iterator(); it
			...
			if (data != null && !data.isEmpty()
				...
				View view = EventpatternDiagramEditorUtil.findView(
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		EventpatternMarkerNavigationProvider.addMarker(target, elementId,
