...
import eventpattern.diagram.edit.policies.Modulus2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Modulus2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Modulus2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Modulus2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Modulus2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
