 ...
 * @generated
 */
public class LessEqualName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LessEqualName2EditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.LessEqualName2EditPart.VISUAL_ID));
		}
		return parser;
	}
