...
public class EventProperty5EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EventProperty5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment5EditPart) {
			...
			pane.add(((EventPropertyEventPropertyEventPropertiesCompartment5EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment5EditPart) {
			IFigure pane = getPrimaryShape()
					.getEventPropertyEventPropertiesCompartmentFigure();
			pane.remove(((EventPropertyEventPropertyEventPropertiesCompartment5EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
