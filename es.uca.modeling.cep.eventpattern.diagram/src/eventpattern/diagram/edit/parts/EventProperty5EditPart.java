...
import eventpattern.diagram.edit.policies.EventProperty5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EventProperty5EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EventProperty5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EventProperty5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventPropertyName5EditPart) {
			((EventPropertyName5EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureEventPropertyLabelFigure());
			return true;
		}
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getEventPropertyEventPropertiesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EventPropertyEventPropertyEventPropertiesCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getEventPropertyEventPropertiesCompartmentFigure();
			pane.remove(((EventPropertyEventPropertyEventPropertiesCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof EventPropertyEventPropertyEventPropertiesCompartment5EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EventpatternVisualIDRegistry.getType(EventPropertyName5EditPart.VISUAL_ID));
	}
