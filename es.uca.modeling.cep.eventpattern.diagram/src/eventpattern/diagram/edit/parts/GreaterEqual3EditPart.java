...
import eventpattern.diagram.edit.policies.GreaterEqual3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GreaterEqual3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public GreaterEqual3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GreaterEqual3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.GreaterEqual3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
