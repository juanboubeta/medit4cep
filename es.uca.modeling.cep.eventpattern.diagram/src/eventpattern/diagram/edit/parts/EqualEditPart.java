...
import eventpattern.diagram.edit.policies.EqualItemSemanticEditPolicy;
...
public class EqualEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EqualEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EqualItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.EqualEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
