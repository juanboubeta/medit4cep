...
import eventpattern.diagram.edit.policies.Min2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Min2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Min2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new MinFigure();
	}

	/**
	 * @generated
	 */
	public MinFigure getPrimaryShape() {
		return (MinFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Min2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class MinFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public MinFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Min.svg");
