 ...
 * @generated
 */
public class OrName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OrName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider
					.getParser(
							EventpatternElementTypes.Or_3004,
							getParserElement(),
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.OrName2EditPart.VISUAL_ID));
		}
		return parser;
	}
