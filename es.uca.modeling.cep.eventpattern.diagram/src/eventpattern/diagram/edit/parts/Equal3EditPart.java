...
import eventpattern.diagram.edit.policies.Equal3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Equal3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Equal3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Equal3ItemSemanticEditPolicy());
	 ...
	 * @generated
	 */
	public EqualFigure getPrimaryShape() {
		return (EqualFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Equal3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class EqualFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public EqualFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Equal.svg");
