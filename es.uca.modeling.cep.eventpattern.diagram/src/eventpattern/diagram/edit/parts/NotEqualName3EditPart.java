 ...
 * @generated
 */
public class NotEqualName3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NotEqualName3EditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.NotEqualName3EditPart.VISUAL_ID));
		}
		return parser;
	}
