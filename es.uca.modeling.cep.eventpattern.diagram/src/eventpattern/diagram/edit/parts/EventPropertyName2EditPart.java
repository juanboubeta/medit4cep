 ...
 * @generated
 */
public class EventPropertyName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.EventPropertyName2EditPart.VISUAL_ID));
		}
		return parser;
	}
