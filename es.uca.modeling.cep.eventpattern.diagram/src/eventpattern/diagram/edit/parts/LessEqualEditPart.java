...
import eventpattern.diagram.edit.policies.LessEqualItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LessEqualEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public LessEqualEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LessEqualItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.LessEqualEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
