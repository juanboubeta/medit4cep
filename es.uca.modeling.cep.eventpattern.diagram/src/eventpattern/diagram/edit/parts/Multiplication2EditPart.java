...
import eventpattern.diagram.edit.policies.Multiplication2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Multiplication2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Multiplication2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Multiplication2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new MultiplicationFigure();
	}

	/**
	 * @generated
	 */
	public MultiplicationFigure getPrimaryShape() {
		return (MultiplicationFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Multiplication2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class MultiplicationFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public MultiplicationFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Multiplication.svg");
