 ...
 * @generated
 */
public class RepeatCount3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RepeatCount3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.Repeat_3043, getParserElement(),
					EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.RepeatCount3EditPart.VISUAL_ID));
		}
		return parser;
	}
