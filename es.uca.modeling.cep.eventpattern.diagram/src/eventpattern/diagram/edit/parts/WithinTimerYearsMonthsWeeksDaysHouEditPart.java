 ...
 * @generated
 */
public class WithinTimerYearsMonthsWeeksDaysHouEditPart extends
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.WithinTimerYearsMonthsWeeksDaysHouEditPart.VISUAL_ID));
		}
		return parser;
	}
