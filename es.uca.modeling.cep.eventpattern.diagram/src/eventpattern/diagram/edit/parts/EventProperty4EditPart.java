...
public class EventProperty4EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EventProperty4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment4EditPart) {
			...
			pane.add(((EventPropertyEventPropertyEventPropertiesCompartment4EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getEventPropertyEventPropertiesCompartmentFigure();
			pane.remove(((EventPropertyEventPropertyEventPropertiesCompartment4EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
