...
import eventpattern.diagram.edit.policies.EventProperty4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EventProperty4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EventProperty4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EventProperty4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventPropertyName4EditPart) {
			((EventPropertyName4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureEventPropertyLabelFigure());
			return true;
		}
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment4EditPart) {
			IFigure pane = getPrimaryShape().getEventPropertyEventPropertiesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EventPropertyEventPropertyEventPropertiesCompartment4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment4EditPart) {
			IFigure pane = getPrimaryShape().getEventPropertyEventPropertiesCompartmentFigure();
			pane.remove(((EventPropertyEventPropertyEventPropertiesCompartment4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof EventPropertyEventPropertyEventPropertiesCompartment4EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EventpatternVisualIDRegistry.getType(EventPropertyName4EditPart.VISUAL_ID));
	}
