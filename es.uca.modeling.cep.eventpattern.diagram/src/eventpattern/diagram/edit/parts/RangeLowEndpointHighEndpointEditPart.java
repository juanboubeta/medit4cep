 ...
 * @generated
 */
public class RangeLowEndpointHighEndpointEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RangeLowEndpointHighEndpointEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.Range_2019, getParserElement(),
					EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.RangeLowEndpointHighEndpointEditPart.VISUAL_ID));
		}
		return parser;
	}
