...
import eventpattern.diagram.edit.policies.GreaterThan2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GreaterThan2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public GreaterThan2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GreaterThan2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new GreaterThanFigure();
	}

	/**
	 * @generated
	 */
	public GreaterThanFigure getPrimaryShape() {
		return (GreaterThanFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.GreaterThan2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class GreaterThanFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public GreaterThanFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/GreaterThan.svg");
