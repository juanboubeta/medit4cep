 ...
 * @generated
 */
public class DivisionNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DivisionNameEditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.DivisionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
