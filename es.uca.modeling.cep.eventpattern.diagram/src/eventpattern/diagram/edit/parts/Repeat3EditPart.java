...
public class Repeat3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Repeat3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RepeatCount3EditPart) {
			((RepeatCount3EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureRepeatLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Repeat3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	...
	public class RepeatFigure extends Ellipse {
		...
		private void createContents() {
			...
			this.add(fFigureRepeatLabelFigure,
					constraintFFigureRepeatLabelFigure);
