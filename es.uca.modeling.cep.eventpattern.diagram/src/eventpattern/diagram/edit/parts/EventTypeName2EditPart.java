 ...
 * @generated
 */
public class EventTypeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EventTypeName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.Event_3024, getParserElement(),
					EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.EventTypeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
