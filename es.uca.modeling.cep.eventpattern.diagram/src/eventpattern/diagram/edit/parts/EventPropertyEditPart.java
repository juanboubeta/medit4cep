...
public class EventPropertyEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EventPropertyItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventPropertyNameEditPart) {
			((EventPropertyNameEditPart) childEditPart)
		...
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment3EditPart) {
			...
			pane.add(((EventPropertyEventPropertyEventPropertiesCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventPropertyEventPropertyEventPropertiesCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getEventPropertyEventPropertiesCompartmentFigure();
			pane.remove(((EventPropertyEventPropertyEventPropertiesCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
