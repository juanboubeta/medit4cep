...
import eventpattern.diagram.edit.policies.Subtraction2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Subtraction2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Subtraction2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Subtraction2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new SubtractionFigure();
	}

	/**
	 * @generated
	 */
	public SubtractionFigure getPrimaryShape() {
		return (SubtractionFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Subtraction2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class SubtractionFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public SubtractionFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Subtraction.svg");
