...
import eventpattern.diagram.edit.policies.NotEqual3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NotEqual3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public NotEqual3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NotEqual3ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new NotEqualFigure();
	}

	/**
	 * @generated
	 */
	public NotEqualFigure getPrimaryShape() {
		return (NotEqualFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.NotEqual3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class NotEqualFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public NotEqualFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/NotEqual.svg");
