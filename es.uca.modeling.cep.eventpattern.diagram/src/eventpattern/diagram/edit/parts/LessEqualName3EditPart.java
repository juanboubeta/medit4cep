 ...
 * @generated
 */
public class LessEqualName3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LessEqualName3EditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.LessEqualName3EditPart.VISUAL_ID));
		}
		return parser;
	}
