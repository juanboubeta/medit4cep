...
import eventpattern.diagram.edit.policies.Every2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Every2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Every2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Every2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Every2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
