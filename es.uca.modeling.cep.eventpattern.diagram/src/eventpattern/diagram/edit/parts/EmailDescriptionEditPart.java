 ...
 * @generated
 */
public class EmailDescriptionEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(EventpatternVisualIDRegistry
				.getType(eventpattern.diagram.edit.parts.EmailDescriptionEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public EmailDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.Email_2033, getParserElement(),
					EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.EmailDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EmailLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EmailLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EmailLabelFigure() {
			this.setText("Email");
		}
