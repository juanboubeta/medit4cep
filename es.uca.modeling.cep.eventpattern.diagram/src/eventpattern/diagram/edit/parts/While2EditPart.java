...
import eventpattern.diagram.edit.policies.While2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class While2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public While2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new While2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.While2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
