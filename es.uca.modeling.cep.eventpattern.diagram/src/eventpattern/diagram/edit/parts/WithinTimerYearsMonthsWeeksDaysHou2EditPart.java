 ...
 * @generated
 */
public class WithinTimerYearsMonthsWeeksDaysHou2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WithinTimerYearsMonthsWeeksDaysHou2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.WithinTimer_3056, getParserElement(),
					EventpatternVisualIDRegistry.getType(
							eventpattern.diagram.edit.parts.WithinTimerYearsMonthsWeeksDaysHou2EditPart.VISUAL_ID));
		}
		return parser;
	}
