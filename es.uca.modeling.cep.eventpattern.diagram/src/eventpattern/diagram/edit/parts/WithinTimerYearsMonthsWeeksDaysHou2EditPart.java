 ...
 * @generated
 */
public class WithinTimerYearsMonthsWeeksDaysHou2EditPart extends
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.WithinTimerYearsMonthsWeeksDaysHou2EditPart.VISUAL_ID));
		}
		return parser;
	}
