...
import eventpattern.diagram.edit.policies.Subtraction3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Subtraction3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Subtraction3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Subtraction3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Subtraction3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
