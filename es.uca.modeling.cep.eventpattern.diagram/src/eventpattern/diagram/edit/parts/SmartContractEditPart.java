...
import eventpattern.diagram.edit.policies.SmartContractItemSemanticEditPolicy;
...
public class SmartContractEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EventpatternVisualIDRegistry.getType(SmartContractTypeNameEditPart.VISUAL_ID));
	}
