...
import eventpattern.diagram.edit.policies.Division2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Division2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Division2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Division2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new DivisionFigure();
	}

	/**
	 * @generated
	 */
	public DivisionFigure getPrimaryShape() {
		return (DivisionFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Division2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class DivisionFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public DivisionFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Division.svg");
