...
import eventpattern.diagram.edit.policies.Every3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Every3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Every3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Every3ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EveryFigure();
	}

	/**
	 * @generated
	 */
	public EveryFigure getPrimaryShape() {
		return (EveryFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Every3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class EveryFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public EveryFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Every.svg");
