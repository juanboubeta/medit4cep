...
import eventpattern.diagram.edit.policies.AdditionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdditionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AdditionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdditionItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.AdditionEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
