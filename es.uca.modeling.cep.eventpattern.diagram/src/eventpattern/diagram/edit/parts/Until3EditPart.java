...
import eventpattern.diagram.edit.policies.Until3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Until3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Until3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Until3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Until3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
