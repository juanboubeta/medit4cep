...
import eventpattern.diagram.edit.policies.Not3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Not3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Not3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Not3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	...
	public class NotFigure extends SVGFigure {
		 ...
		 */
		public NotFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Not.svg");
