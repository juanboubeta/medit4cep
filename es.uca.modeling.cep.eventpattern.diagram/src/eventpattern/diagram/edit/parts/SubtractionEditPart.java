...
import eventpattern.diagram.edit.policies.SubtractionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubtractionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SubtractionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubtractionItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.SubtractionEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
