...
import eventpattern.diagram.edit.policies.Max2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Max2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Max2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new MaxFigure();
	}

	/**
	 * @generated
	 */
	public MaxFigure getPrimaryShape() {
		return (MaxFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Max2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class MaxFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public MaxFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Max.svg");
