 ...
 * @generated
 */
public class RangeLowEndpointHighEndpoint3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RangeLowEndpointHighEndpoint3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.Range_3045, getParserElement(),
					EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.RangeLowEndpointHighEndpoint3EditPart.VISUAL_ID));
		}
		return parser;
	}
