...
import eventpattern.diagram.edit.policies.TimeIntervalItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TimeIntervalEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TimeIntervalItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof TimeIntervalYearsMonthsWeeksDaysHouEditPart) {
