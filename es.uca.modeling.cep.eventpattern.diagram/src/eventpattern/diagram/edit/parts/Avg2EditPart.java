...
import eventpattern.diagram.edit.policies.Avg2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Avg2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Avg2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new AvgFigure();
	}

	/**
	 * @generated
	 */
	public AvgFigure getPrimaryShape() {
		return (AvgFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Avg2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class AvgFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public AvgFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Avg.svg");
