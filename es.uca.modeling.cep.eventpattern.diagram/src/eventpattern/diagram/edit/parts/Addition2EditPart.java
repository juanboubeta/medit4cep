...
import eventpattern.diagram.edit.policies.Addition2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Addition2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Addition2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Addition2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new AdditionFigure();
	}

	/**
	 * @generated
	 */
	public AdditionFigure getPrimaryShape() {
		return (AdditionFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Addition2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class AdditionFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public AdditionFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Addition.svg");
