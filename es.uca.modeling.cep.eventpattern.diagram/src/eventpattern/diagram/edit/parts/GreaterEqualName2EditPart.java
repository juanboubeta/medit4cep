 ...
 * @generated
 */
public class GreaterEqualName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GreaterEqualName2EditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.GreaterEqualName2EditPart.VISUAL_ID));
		}
		return parser;
	}
