...
import eventpattern.diagram.edit.policies.NotEqualItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NotEqualEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public NotEqualEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NotEqualItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.NotEqualEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
