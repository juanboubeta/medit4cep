 ...
 * @generated
 */
public class AdditionName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AdditionName2EditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.AdditionName2EditPart.VISUAL_ID));
		}
		return parser;
	}
