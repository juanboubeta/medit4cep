...
import eventpattern.diagram.edit.policies.Event2ItemSemanticEditPolicy;
...
public class Event2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventTypeName2EditPart) {
			((EventTypeName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureEventLabelFigure());
			return true;
		}
		if (childEditPart instanceof EventEventEventPropertiesCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getEventEventPropertiesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EventEventEventPropertiesCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventEventEventPropertiesCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getEventEventPropertiesCompartmentFigure();
			pane.remove(((EventEventEventPropertiesCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof EventEventEventPropertiesCompartment2EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EventpatternVisualIDRegistry.getType(EventTypeName2EditPart.VISUAL_ID));
	}
