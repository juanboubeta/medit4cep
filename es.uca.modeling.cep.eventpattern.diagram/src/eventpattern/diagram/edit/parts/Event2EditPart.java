...
public class Event2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventTypeName2EditPart) {
			((EventTypeName2EditPart) childEditPart).setLabel(getPrimaryShape()
		...
		if (childEditPart instanceof EventEventEventPropertiesCompartment2EditPart) {
			...
			pane.add(((EventEventEventPropertiesCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventEventEventPropertiesCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getEventEventPropertiesCompartmentFigure();
			pane.remove(((EventEventEventPropertiesCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
