...
import eventpattern.diagram.edit.policies.UntilItemSemanticEditPolicy;
 ...
 * @generated
 */
public class UntilEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UntilEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UntilItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.UntilEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
