...
public class Event3EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventTypeName3EditPart) {
			((EventTypeName3EditPart) childEditPart).setLabel(getPrimaryShape()
		...
		if (childEditPart instanceof EventEventEventPropertiesCompartment3EditPart) {
			...
			pane.add(((EventEventEventPropertiesCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventEventEventPropertiesCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getEventEventPropertiesCompartmentFigure();
			pane.remove(((EventEventEventPropertiesCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
