...
public class WithinTimerEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WithinTimerItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WithinTimerWithinTimerWithinTimerElementsCompartmentEditPart) {
			...
			pane.add(((WithinTimerWithinTimerWithinTimerElementsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WithinTimerWithinTimerWithinTimerElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getWithinTimerWithinTimerElementsCompartmentFigure();
			pane.remove(((WithinTimerWithinTimerWithinTimerElementsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
