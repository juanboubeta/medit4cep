...
import eventpattern.diagram.edit.policies.Multiplication3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Multiplication3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Multiplication3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Multiplication3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Multiplication3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
