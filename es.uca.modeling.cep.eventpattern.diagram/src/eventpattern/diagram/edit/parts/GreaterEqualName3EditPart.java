 ...
 * @generated
 */
public class GreaterEqualName3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GreaterEqualName3EditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.GreaterEqualName3EditPart.VISUAL_ID));
		}
		return parser;
	}
