 ...
 * @generated
 */
public class ValueValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ValueValueEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.Value_2029, getParserElement(),
					EventpatternVisualIDRegistry.getType(eventpattern.diagram.edit.parts.ValueValueEditPart.VISUAL_ID));
		}
		return parser;
	}
