...
import eventpattern.diagram.edit.policies.Sum2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Sum2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Sum2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new SumFigure();
	}

	/**
	 * @generated
	 */
	public SumFigure getPrimaryShape() {
		return (SumFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Sum2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class SumFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public SumFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Sum.svg");
