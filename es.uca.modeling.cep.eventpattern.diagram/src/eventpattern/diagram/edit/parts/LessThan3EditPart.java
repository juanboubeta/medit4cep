...
import eventpattern.diagram.edit.policies.LessThan3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LessThan3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public LessThan3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LessThan3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.LessThan3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
