...
import eventpattern.diagram.edit.policies.LessThan2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LessThan2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public LessThan2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LessThan2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new LessThanFigure();
	}

	/**
	 * @generated
	 */
	public LessThanFigure getPrimaryShape() {
		return (LessThanFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.LessThan2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class LessThanFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public LessThanFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/LessThan.svg");
