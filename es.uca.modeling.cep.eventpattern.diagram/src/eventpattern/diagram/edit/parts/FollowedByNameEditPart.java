 ...
 * @generated
 */
public class FollowedByNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FollowedByNameEditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.FollowedByNameEditPart.VISUAL_ID));
		}
		return parser;
	}
