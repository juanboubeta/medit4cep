 ...
 * @generated
 */
public class GreaterEqualNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GreaterEqualNameEditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.GreaterEqualNameEditPart.VISUAL_ID));
		}
		return parser;
	}
