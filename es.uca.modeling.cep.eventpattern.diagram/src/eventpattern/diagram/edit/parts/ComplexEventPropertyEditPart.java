...
import eventpattern.diagram.edit.policies.ComplexEventPropertyItemSemanticEditPolicy;
...
public class ComplexEventPropertyEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EventpatternVisualIDRegistry.getType(ComplexEventPropertyNameEditPart.VISUAL_ID));
	}
	 ...
	 * a ComplexEventProperty node is changed.
	 * @generated NOT
	 */
		...
		if (event.getNotifier() == getModel()
			...
			if (event.getFeature() instanceof EAttribute) {
				...
				if (eAttribute.getName().equalsIgnoreCase("imagePath")) {
					ComplexEventPropertyFigure figure = (ComplexEventPropertyFigure) this.getPrimaryShape();
					...
					if (elementName != null && !elementName.equals("") && new File(elementName).exists()) {
						...
						figure.getFigureComplexEventPropertyLabelFigure().setIcon(scaledImage);

						EventPatternsStatus.getComplexEventChanges().put(activePatternName, true);
					}
				} else if (eAttribute.getName().equalsIgnoreCase("name")) {
