...
import eventpattern.diagram.edit.policies.EveryDistinct3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EveryDistinct3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EveryDistinct3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EveryDistinct3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.EveryDistinct3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
