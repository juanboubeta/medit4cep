...
import eventpattern.diagram.edit.policies.LessEqual2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LessEqual2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public LessEqual2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LessEqual2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.LessEqual2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
