...
import eventpattern.diagram.edit.policies.FollowedBy3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FollowedBy3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public FollowedBy3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FollowedBy3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.FollowedBy3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
