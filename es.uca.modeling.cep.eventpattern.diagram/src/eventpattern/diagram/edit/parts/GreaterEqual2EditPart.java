...
import eventpattern.diagram.edit.policies.GreaterEqual2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GreaterEqual2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public GreaterEqual2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GreaterEqual2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new GreaterEqualFigure();
	}

	/**
	 * @generated
	 */
	public GreaterEqualFigure getPrimaryShape() {
		return (GreaterEqualFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.GreaterEqual2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class GreaterEqualFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public GreaterEqualFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/GreaterEqual.svg");
