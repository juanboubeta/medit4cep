...
import eventpattern.diagram.edit.policies.CountItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CountEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CountEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CountItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.CountEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
