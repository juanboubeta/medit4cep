...
import eventpattern.diagram.edit.policies.EveryDistinct2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EveryDistinct2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EveryDistinct2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EveryDistinct2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EveryDistinctFigure();
	}

	/**
	 * @generated
	 */
	public EveryDistinctFigure getPrimaryShape() {
		return (EveryDistinctFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.EveryDistinct2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class EveryDistinctFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public EveryDistinctFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/EveryDistinct.svg");
