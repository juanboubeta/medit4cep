 ...
 * @generated
 */
public class BatchingTimeIntervalYearsMonthsWeeksDaysHouEditPart extends
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.BatchingTimeIntervalYearsMonthsWeeksDaysHouEditPart.VISUAL_ID));
		}
		return parser;
	}
