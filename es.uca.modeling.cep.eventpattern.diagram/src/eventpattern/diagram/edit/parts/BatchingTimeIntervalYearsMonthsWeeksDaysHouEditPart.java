 ...
 * @generated
 */
public class BatchingTimeIntervalYearsMonthsWeeksDaysHouEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public BatchingTimeIntervalYearsMonthsWeeksDaysHouEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.BatchingTimeInterval_2037,
					getParserElement(), EventpatternVisualIDRegistry.getType(
							eventpattern.diagram.edit.parts.BatchingTimeIntervalYearsMonthsWeeksDaysHouEditPart.VISUAL_ID));
		}
		return parser;
	}
