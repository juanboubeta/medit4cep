...
import eventpattern.diagram.edit.policies.Until2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Until2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Until2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Until2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new UntilFigure();
	}

	/**
	 * @generated
	 */
	public UntilFigure getPrimaryShape() {
		return (UntilFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Until2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class UntilFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public UntilFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Until.svg");
