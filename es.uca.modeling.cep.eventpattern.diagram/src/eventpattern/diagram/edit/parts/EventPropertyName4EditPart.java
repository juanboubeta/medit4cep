 ...
 * @generated
 */
public class EventPropertyName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EventPropertyName4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.EventProperty_3025,
					getParserElement(), EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.EventPropertyName4EditPart.VISUAL_ID));
		}
		return parser;
	}
