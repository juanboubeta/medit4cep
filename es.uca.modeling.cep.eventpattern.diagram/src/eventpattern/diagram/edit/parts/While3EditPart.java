...
import eventpattern.diagram.edit.policies.While3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class While3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public While3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new While3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.While3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class WhileFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public WhileFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/While.svg");
