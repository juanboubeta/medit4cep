 ...
 * @generated
 */
public class ComplexEventTypeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected Image getLabelIcon() {
		...
		if (eObject instanceof ComplexEvent) {
			...
			if (imagePath == null || imagePath.equals("")
				...
				return EventpatternElementTypes
			...
			scaledImage = new Image(Display.getDefault(), image.getImageData()
					.scaledTo(20, 20));
