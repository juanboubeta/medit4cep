 ...
 * @generated
 */
public class MultiplicationNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MultiplicationNameEditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.MultiplicationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
