 ...
 * @generated
 */
public class GreaterThanNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GreaterThanNameEditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.GreaterThanNameEditPart.VISUAL_ID));
		}
		return parser;
	}
