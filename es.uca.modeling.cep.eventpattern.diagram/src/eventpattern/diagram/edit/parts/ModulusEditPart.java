...
import eventpattern.diagram.edit.policies.ModulusItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ModulusEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ModulusEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ModulusItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.ModulusEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
