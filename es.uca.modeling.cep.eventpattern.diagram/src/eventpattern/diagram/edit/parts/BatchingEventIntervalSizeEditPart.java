 ...
 * @generated
 */
public class BatchingEventIntervalSizeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BatchingEventIntervalSizeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.BatchingEventInterval_2035,
					getParserElement(), EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.BatchingEventIntervalSizeEditPart.VISUAL_ID));
		}
		return parser;
	}
