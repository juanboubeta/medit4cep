...
import eventpattern.diagram.edit.policies.And3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class And3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new And3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.And3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
