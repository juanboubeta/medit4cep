...
import eventpattern.diagram.edit.policies.EveryItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EveryEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EveryEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EveryItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.EveryEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
