 ...
 * @generated
 */
public class MultiplicationName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MultiplicationName2EditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.MultiplicationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
