 ...
 * @generated
 */
public class EveryDistinctName3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EveryDistinctName3EditPart(View view) {
		super(view);
	}
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.EveryDistinctName3EditPart.VISUAL_ID));
		}
		return parser;
	}
