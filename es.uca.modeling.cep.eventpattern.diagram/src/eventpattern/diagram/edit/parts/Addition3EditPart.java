...
import eventpattern.diagram.edit.policies.Addition3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Addition3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Addition3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Addition3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Addition3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
