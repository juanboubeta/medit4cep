 ...
 * @generated
 */
public class EventPropertyNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = EventpatternParserProvider
					.getParser(
							...
							EventpatternVisualIDRegistry
									.getType(eventpattern.diagram.edit.parts.EventPropertyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
