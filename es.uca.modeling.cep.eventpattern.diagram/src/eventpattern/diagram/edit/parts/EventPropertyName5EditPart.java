 ...
 * @generated
 */
public class EventPropertyName5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EventPropertyName5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.EventProperty_3054,
					getParserElement(), EventpatternVisualIDRegistry
							.getType(eventpattern.diagram.edit.parts.EventPropertyName5EditPart.VISUAL_ID));
		}
		return parser;
	}
