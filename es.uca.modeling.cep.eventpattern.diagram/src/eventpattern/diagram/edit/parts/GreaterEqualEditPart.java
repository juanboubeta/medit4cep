...
import eventpattern.diagram.edit.policies.GreaterEqualItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GreaterEqualEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public GreaterEqualEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GreaterEqualItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.GreaterEqualEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
