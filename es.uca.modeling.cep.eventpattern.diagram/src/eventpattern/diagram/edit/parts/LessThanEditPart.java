...
import eventpattern.diagram.edit.policies.LessThanItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LessThanEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public LessThanEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LessThanItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.LessThanEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
