...
import eventpattern.diagram.edit.policies.DivisionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DivisionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DivisionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DivisionItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.DivisionEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
