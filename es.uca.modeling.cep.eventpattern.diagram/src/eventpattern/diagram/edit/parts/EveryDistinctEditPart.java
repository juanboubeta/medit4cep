...
import eventpattern.diagram.edit.policies.EveryDistinctItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EveryDistinctEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EveryDistinctEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EveryDistinctItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.EveryDistinctEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
