...
import eventpattern.diagram.edit.policies.Modulus3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Modulus3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Modulus3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Modulus3ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ModulusFigure();
	}

	/**
	 * @generated
	 */
	public ModulusFigure getPrimaryShape() {
		return (ModulusFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Modulus3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class ModulusFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public ModulusFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Modulus.svg");
