...
import eventpattern.diagram.edit.policies.MultiplicationItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MultiplicationEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public MultiplicationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MultiplicationItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.MultiplicationEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
