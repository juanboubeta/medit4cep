 ...
 * @generated
 */
public class TimeScheduleDayOfWeekDayOfMonthMont2EditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				EventpatternVisualIDRegistry.getType(
						eventpattern.diagram.edit.parts.TimeScheduleDayOfWeekDayOfMonthMont2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public TimeScheduleDayOfWeekDayOfMonthMont2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.TimeSchedule_3058,
