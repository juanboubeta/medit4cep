...
import eventpattern.diagram.edit.policies.Division3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Division3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Division3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Division3ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Division3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
