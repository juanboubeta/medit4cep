...
import eventpattern.diagram.edit.policies.Range3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Range3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Range3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Range3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RangeLowEndpointHighEndpoint3EditPart) {
			((RangeLowEndpointHighEndpoint3EditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Range3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
