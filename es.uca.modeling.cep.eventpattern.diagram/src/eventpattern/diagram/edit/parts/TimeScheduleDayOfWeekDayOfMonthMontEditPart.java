 ...
 * @generated
 */
public class TimeScheduleDayOfWeekDayOfMonthMontEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				EventpatternVisualIDRegistry
						.getType(eventpattern.diagram.edit.parts.TimeScheduleDayOfWeekDayOfMonthMontEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public TimeScheduleDayOfWeekDayOfMonthMontEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.TimeSchedule_2032,
					getParserElement(), EventpatternVisualIDRegistry.getType(
							eventpattern.diagram.edit.parts.TimeScheduleDayOfWeekDayOfMonthMontEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new TimeScheduleLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TimeScheduleLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TimeScheduleLabelFigure() {
			this.setText("TimeSchedule");
		}
