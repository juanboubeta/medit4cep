...
import eventpattern.diagram.edit.policies.Count2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Count2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Count2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Count2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CountFigure();
	}

	/**
	 * @generated
	 */
	public CountFigure getPrimaryShape() {
		return (CountFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Count2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class CountFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public CountFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Count.svg");
