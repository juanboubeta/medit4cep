...
import eventpattern.diagram.edit.policies.Or3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Or3EditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.Or3EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	...
	public class OrFigure extends SVGFigure {
		 ...
		 */
		public OrFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/Or.svg");
