...
import eventpattern.diagram.edit.policies.NotEqual2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NotEqual2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public NotEqual2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NotEqual2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.NotEqual2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
