 ...
 * @generated
 */
public class TimeIntervalYearsMonthsWeeksDaysHou2EditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				EventpatternVisualIDRegistry.getType(
						eventpattern.diagram.edit.parts.TimeIntervalYearsMonthsWeeksDaysHou2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public TimeIntervalYearsMonthsWeeksDaysHou2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventpatternParserProvider.getParser(EventpatternElementTypes.TimeInterval_3057,
	...
	protected IFigure createFigurePrim() {
		return new TimeIntervalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TimeIntervalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TimeIntervalLabelFigure() {
			this.setText("TimeInterval");
		}
