...
import eventpattern.diagram.edit.policies.FollowedByItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FollowedByEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public FollowedByEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FollowedByItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.FollowedByEditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
