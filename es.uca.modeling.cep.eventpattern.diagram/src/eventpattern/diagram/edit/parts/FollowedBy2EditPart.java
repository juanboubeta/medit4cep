...
import eventpattern.diagram.edit.policies.FollowedBy2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FollowedBy2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public FollowedBy2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FollowedBy2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new FollowedByFigure();
	}

	/**
	 * @generated
	 */
	public FollowedByFigure getPrimaryShape() {
		return (FollowedByFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eventpattern.diagram.edit.parts.FollowedBy2EditPart) {
			types.add(EventpatternElementTypes.Link_4001);
		}
	 ...
	 * @generated
	 */
	public class FollowedByFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public FollowedByFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.cep.eventpattern.figures/svg/FollowedBy.svg");
