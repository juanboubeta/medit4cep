 ...
 * @generated
 */
public class EventPropertyEventPropertyEventPropertiesCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getEventPropertyEventPropertyEventPropertiesCompartment_7007SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getEventPropertyEventPropertyEventPropertiesCompartment_7007SemanticChildren(
