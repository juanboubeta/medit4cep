...
public class SlidingEventIntervalSlidingEventIntervalEventPatternConditionsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getSlidingEventIntervalSlidingEventIntervalEventPatternConditionsCompartment_7008SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getSlidingEventIntervalSlidingEventIntervalEventPatternConditionsCompartment_7008SemanticChildren((View) getHost()
						.getModel());
