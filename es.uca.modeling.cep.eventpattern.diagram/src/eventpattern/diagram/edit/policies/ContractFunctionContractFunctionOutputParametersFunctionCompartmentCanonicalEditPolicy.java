...
public class ContractFunctionContractFunctionOutputParametersFunctionCompartmentCanonicalEditPolicy
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return EventpatternPackage.eINSTANCE.getContractFunction_OutputParametersFunction();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getContractFunctionContractFunctionOutputParametersFunctionCompartment_7018SemanticChildren(
						viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return OutputParameterEditPart.VISUAL_ID == EventpatternVisualIDRegistry.getVisualID(view);
	}
