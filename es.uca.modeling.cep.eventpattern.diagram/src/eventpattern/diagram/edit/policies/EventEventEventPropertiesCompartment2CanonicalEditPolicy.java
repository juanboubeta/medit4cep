 ...
 * @generated
 */
public class EventEventEventPropertiesCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected void refreshSemantic() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getEventEventEventPropertiesCompartment_7006SemanticChildren((View) getHost()
						.getModel());
