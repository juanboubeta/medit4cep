 ...
 * @generated
 */
public class EventEventEventPropertiesCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getEventEventEventPropertiesCompartment_7009SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getEventEventEventPropertiesCompartment_7009SemanticChildren((View) getHost().getModel());
