 ...
 * @generated
 */
public class EventEventEventPropertiesCompartment3CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return EventProperty2EditPart.VISUAL_ID == EventpatternVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getEventEventEventPropertiesCompartment_7009SemanticChildren((View) getHost()
						.getModel());
