...
public class SmartContractSmartContractSmartContractPropertiesCompartmentCanonicalEditPolicy
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return EventpatternPackage.eINSTANCE.getSmartContract_SmartContractProperties();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getSmartContractSmartContractSmartContractPropertiesCompartment_7016SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ContractFunctionEditPart.VISUAL_ID == EventpatternVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getSmartContractSmartContractSmartContractPropertiesCompartment_7016SemanticChildren(
