 ...
 * @generated
 */
public class EventPropertyEventPropertyEventPropertiesCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getEventPropertyEventPropertyEventPropertiesCompartment_7004SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getEventPropertyEventPropertyEventPropertiesCompartment_7004SemanticChildren(
