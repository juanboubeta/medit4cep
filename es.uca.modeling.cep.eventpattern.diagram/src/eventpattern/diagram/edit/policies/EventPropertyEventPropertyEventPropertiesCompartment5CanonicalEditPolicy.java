 ...
 * @generated
 */
public class EventPropertyEventPropertyEventPropertiesCompartment5CanonicalEditPolicy
	...
	private boolean isMyDiagramElement(View view) {
		return EventProperty3EditPart.VISUAL_ID == EventpatternVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getEventPropertyEventPropertyEventPropertiesCompartment_7010SemanticChildren((View) getHost()
						.getModel());
