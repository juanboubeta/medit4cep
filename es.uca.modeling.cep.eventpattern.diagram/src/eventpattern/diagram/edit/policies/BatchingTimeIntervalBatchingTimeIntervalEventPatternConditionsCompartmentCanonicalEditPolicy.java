...
public class BatchingTimeIntervalBatchingTimeIntervalEventPatternConditionsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getBatchingTimeIntervalBatchingTimeIntervalEventPatternConditionsCompartment_7014SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getBatchingTimeIntervalBatchingTimeIntervalEventPatternConditionsCompartment_7014SemanticChildren((View) getHost()
						.getModel());
