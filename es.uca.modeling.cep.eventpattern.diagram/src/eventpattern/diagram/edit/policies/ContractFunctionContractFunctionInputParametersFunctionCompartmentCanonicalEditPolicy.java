...
public class ContractFunctionContractFunctionInputParametersFunctionCompartmentCanonicalEditPolicy
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return EventpatternPackage.eINSTANCE.getContractFunction_InputParametersFunction();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getContractFunctionContractFunctionInputParametersFunctionCompartment_7017SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return InputParameterEditPart.VISUAL_ID == EventpatternVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<EventpatternNodeDescriptor> childDescriptors = EventpatternDiagramUpdater
				.getContractFunctionContractFunctionInputParametersFunctionCompartment_7017SemanticChildren(
