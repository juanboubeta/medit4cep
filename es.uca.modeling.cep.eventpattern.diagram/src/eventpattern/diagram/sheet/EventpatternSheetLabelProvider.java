...
import eventpattern.diagram.navigator.EventpatternNavigatorGroup;
...
public class EventpatternSheetLabelProvider extends BaseLabelProvider implements ILabelProvider {
	...
	public String getText(Object element) {
		...
		if (element instanceof EventpatternNavigatorGroup) {
			return ((EventpatternNavigatorGroup) element).getGroupName();
		}
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = EventpatternVisualIDRegistry.getVisualID(view);
			IElementType etype = EventpatternElementTypes.getElementType(vid);
			if (etype != null) {
				return etype;
			}
