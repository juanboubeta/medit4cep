 ...
 * @generated
 */
public class EventpatternModelingAssistantProviderOfContractFunctionEditPart
	...
	*/
	...
	public List<IElementType> getTypesForPopupBar(IAdaptable host) {
		...
		types.add(EventpatternElementTypes.InputParameter_3062);
		types.add(EventpatternElementTypes.OutputParameter_3063);
		return types;
	}
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((ContractFunctionEditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(ContractFunctionEditPart target) {
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((ContractFunctionEditPart) targetEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(ContractFunctionEditPart target, IElementType relationshipType) {
