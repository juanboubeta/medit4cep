 ...
 * @generated
 */
public class SmartcontractViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateDiagramViewOperation op) {
		return SmartContractsEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& SmartcontractVisualIDRegistry.getDiagramVisualID(getSemanticElement(op.getSemanticAdapter())) != -1;
	}
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = SmartcontractVisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = SmartcontractVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!SmartcontractElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null && visualID != SmartcontractVisualIDRegistry
						.getNodeVisualID(op.getContainerView(), domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!SmartContractsEditPart.MODEL_ID
						.equals(SmartcontractVisualIDRegistry.getModelID(op.getContainerView()))) {
	...
	*/
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op.getSemanticAdapter());
		if (!SmartcontractElementTypes.isKnownElementType(elementType) || (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		...
		int visualID = SmartcontractVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != SmartcontractVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	*/
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(SmartContractsEditPart.MODEL_ID);
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		if (semanticHint == null) {
			visualID = SmartcontractVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		} else {
			visualID = SmartcontractVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case SmartContractEditPart.VISUAL_ID:
	...
	*/
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (SmartcontractVisualIDRegistry.getVisualID(elementTypeHint)) {
		}
	...
	*/
	public Node createSmartContract_2003(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setType(SmartcontractVisualIDRegistry.getType(SmartContractEditPart.VISUAL_ID));
	...
	*/
	public Node createContractFunction_3009(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(SmartcontractVisualIDRegistry.getType(ContractFunctionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	*/
	public Node createInputParameter_3010(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(SmartcontractVisualIDRegistry.getType(InputParameterEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	*/
	public Node createOutputParameter_3011(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(SmartcontractVisualIDRegistry.getType(OutputParameterEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	*/
	private void stampShortcut(View containerView, Node target) {
		if (!SmartContractsEditPart.MODEL_ID.equals(SmartcontractVisualIDRegistry.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put("modelID", SmartContractsEditPart.MODEL_ID); //$NON-NLS-1$
