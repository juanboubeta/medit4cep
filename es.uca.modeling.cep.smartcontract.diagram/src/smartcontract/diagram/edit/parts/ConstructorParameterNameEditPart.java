...
import smartcontract.diagram.edit.policies.SmartcontractTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ConstructorParameterNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ConstructorParameterNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new SmartcontractTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return SmartcontractElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SmartcontractParserProvider.getParser(SmartcontractElementTypes.ConstructorParameter_3012,
					getParserElement(), SmartcontractVisualIDRegistry
							.getType(smartcontract.diagram.edit.parts.ConstructorParameterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
					new TextDirectEditManager(this, null, SmartcontractEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
