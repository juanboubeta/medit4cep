 ...
 * @generated
 */
public class SmartcontractNavigatorContentProvider implements ICommonContentProvider {
	...
	*/
	...
	public SmartcontractNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			ArrayList<SmartcontractNavigatorItem> result = new ArrayList<SmartcontractNavigatorItem>();
			...
			result.addAll(
					createNavigatorItems(selectViewsByType(topViews, SmartContractsEditPart.MODEL_ID), file, false));
			return result.toArray();
		}

		if (parentElement instanceof SmartcontractNavigatorGroup) {
			SmartcontractNavigatorGroup group = (SmartcontractNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof SmartcontractNavigatorItem) {
			SmartcontractNavigatorItem navigatorItem = (SmartcontractNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case SmartContractsEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					SmartcontractVisualIDRegistry.getType(SmartContractEditPart.VISUAL_ID));
		...
		case SmartContractEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(connectedViews,
					SmartcontractVisualIDRegistry.getType(ContractFunctionEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			return result.toArray();
		}
		...
		case ContractFunctionEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(connectedViews,
					SmartcontractVisualIDRegistry.getType(InputParameterEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv), SmartcontractVisualIDRegistry
					.getType(ContractFunctionContractFunctionOutputParametersFunctionCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					SmartcontractVisualIDRegistry.getType(OutputParameterEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			return result.toArray();
		}
		}
	...
	*/
	 ...
	 * @generated
	 */
	private Collection<SmartcontractNavigatorItem> createNavigatorItems(Collection<View> views, Object parent,
			boolean isLeafs) {
		ArrayList<SmartcontractNavigatorItem> result = new ArrayList<SmartcontractNavigatorItem>(views.size());
		for (View nextView : views) {
			result.add(new SmartcontractNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private Collection<SmartcontractNavigatorItem> getForeignShortcuts(Diagram diagram, Object parent) {
		LinkedList<View> result = new LinkedList<View>();
	...
	*/
	public Object getParent(Object element) {
		if (element instanceof SmartcontractAbstractNavigatorItem) {
			SmartcontractAbstractNavigatorItem abstractNavigatorItem = (SmartcontractAbstractNavigatorItem) element;
