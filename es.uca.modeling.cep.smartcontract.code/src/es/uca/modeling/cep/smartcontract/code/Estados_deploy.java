...
public class Estados_deploy {
	
	private final static BigInteger GAS_LIMIT = BigInteger.valueOf(6721975L);
	private final static BigInteger GAS_PRICE = BigInteger.valueOf(2000000000L);
	private final static String PRIVATE_KEY = "a16cf2ee4250a7b499891cd4735ced93c07cfa34393953e47ff404cf35fe44d3";
	...
	public Estados_deploy() throws Exception {
		...
		File contractAddress = new File("Estados_contractAddress.txt");
		BufferedWriter bw;
	...
	private String deployContract(Web3j web3j, Credentials credentials) throws Exception {
			return Estados.deploy(web3j, credentials, GAS_PRICE, GAS_LIMIT)
			.send()
			.getContractAddress();
	}	
