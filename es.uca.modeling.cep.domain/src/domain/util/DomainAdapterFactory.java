...
public class DomainAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected DomainSwitch<Adapter> modelSwitch =
    new DomainSwitch<Adapter>() {
			@Override
			public Adapter caseCEPDomain(CEPDomain object) {
				return createCEPDomainAdapter();
			}
			@Override
  ...
  /**
	 * Creates a new adapter for an object of class '{@link domain.CEPDomain <em>CEP Domain</em>}'.
	 * <!-- begin-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  public Adapter createCEPDomainAdapter()
  {
		return null;
	}

  /**
	 * Creates a new adapter for an object of class '{@link domain.Event <em>Event</em>}'.
	 * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
	 * Creates a new adapter for an object of class '{@link domain.EventProperty <em>Event Property</em>}'.
	 * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
