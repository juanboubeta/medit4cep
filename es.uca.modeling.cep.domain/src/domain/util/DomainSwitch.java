...
public class DomainSwitch<T> extends Switch<T>
{
  ...
  {
		switch (classifierID) {
			case DomainPackage.CEP_DOMAIN: {
				CEPDomain cepDomain = (CEPDomain)theEObject;
				T result = caseCEPDomain(cepDomain);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DomainPackage.EVENT: {
				Event event = (Event)theEObject;
				T result = caseEvent(event);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DomainPackage.EVENT_PROPERTY: {
  ...
  /**
	 * Returns the result of interpreting the object as an instance of '<em>CEP Domain</em>'.
	 * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>CEP Domain</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
  public T caseCEPDomain(CEPDomain object)
  {
		return null;
	}
