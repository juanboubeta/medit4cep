...
public class InputParameterImpl extends ParameterImpl implements InputParameter {
	...
	public ContractFunction getInputReferencedFunction() {
		if (eContainerFeatureID() != EventpatternPackage.INPUT_PARAMETER__INPUT_REFERENCED_FUNCTION) return null;
	...
	public NotificationChain basicSetInputReferencedFunction(ContractFunction newInputReferencedFunction, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newInputReferencedFunction, EventpatternPackage.INPUT_PARAMETER__INPUT_REFERENCED_FUNCTION, msgs);
		return msgs;
	}
	...
	public void setInputReferencedFunction(ContractFunction newInputReferencedFunction) {
		if (newInputReferencedFunction != eInternalContainer() || (eContainerFeatureID() != EventpatternPackage.INPUT_PARAMETER__INPUT_REFERENCED_FUNCTION && newInputReferencedFunction != null)) {
			...
			if (newInputReferencedFunction != null)
				msgs = ((InternalEObject)newInputReferencedFunction).eInverseAdd(this, EventpatternPackage.CONTRACT_FUNCTION__INPUT_PARAMETERS_FUNCTION, ContractFunction.class, msgs);
			msgs = basicSetInputReferencedFunction(newInputReferencedFunction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventpatternPackage.INPUT_PARAMETER__INPUT_REFERENCED_FUNCTION, newInputReferencedFunction, newInputReferencedFunction));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case EventpatternPackage.INPUT_PARAMETER__INPUT_REFERENCED_FUNCTION:
				return eInternalContainer().eInverseRemove(this, EventpatternPackage.CONTRACT_FUNCTION__INPUT_PARAMETERS_FUNCTION, ContractFunction.class, msgs);
		}
