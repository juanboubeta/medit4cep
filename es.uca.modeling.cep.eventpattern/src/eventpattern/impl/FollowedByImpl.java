 ...
 * </p>
 * <ul>
 *   <li>{@link eventpattern.impl.FollowedByImpl#getOutboundLink <em>Outbound Link</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FollowedByImpl extends NaryOperatorImpl implements FollowedBy
{
  /**
  ...
  {
		return EventpatternPackage.Literals.FOLLOWED_BY;
	}
  ...
  public EList<Link> getOutboundLink()
  {
		if (outboundLink == null) {
			outboundLink = new EObjectWithInverseResolvingEList<Link>(Link.class, this, EventpatternPackage.FOLLOWED_BY__OUTBOUND_LINK, EventpatternPackage.LINK__OPERAND);
		}
		return outboundLink;
	}
  ...
  {
		switch (featureID) {
			case EventpatternPackage.FOLLOWED_BY__OUTBOUND_LINK:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
		if (baseClass == Operand.class) {
			switch (derivedFeatureID) {
				case EventpatternPackage.FOLLOWED_BY__OUTBOUND_LINK: return EventpatternPackage.OPERAND__OUTBOUND_LINK;
				default: return -1;
			}
		}
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
		if (baseClass == Operand.class) {
			switch (baseFeatureID) {
				case EventpatternPackage.OPERAND__OUTBOUND_LINK: return EventpatternPackage.FOLLOWED_BY__OUTBOUND_LINK;
				default: return -1;
			}
		}
		if (baseClass == EventPatternElement.class) {
