...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sliding Time Interval</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link eventpattern.impl.SlidingTimeIntervalImpl#getYears <em>Years</em>}</li>
 *   <li>{@link eventpattern.impl.SlidingTimeIntervalImpl#getMonths <em>Months</em>}</li>
 *   <li>{@link eventpattern.impl.SlidingTimeIntervalImpl#getWeeks <em>Weeks</em>}</li>
 *   <li>{@link eventpattern.impl.SlidingTimeIntervalImpl#getDays <em>Days</em>}</li>
 *   <li>{@link eventpattern.impl.SlidingTimeIntervalImpl#getHours <em>Hours</em>}</li>
 *   <li>{@link eventpattern.impl.SlidingTimeIntervalImpl#getMinutes <em>Minutes</em>}</li>
 *   <li>{@link eventpattern.impl.SlidingTimeIntervalImpl#getSeconds <em>Seconds</em>}</li>
 *   <li>{@link eventpattern.impl.SlidingTimeIntervalImpl#getMilliseconds <em>Milliseconds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SlidingTimeIntervalImpl extends DataWindowImpl implements SlidingTimeInterval
{
  /**
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  protected SlidingTimeIntervalImpl()
  {
		super();
	}
  ...
  {
		return EventpatternPackage.Literals.SLIDING_TIME_INTERVAL;
	}
  ...
  public void setYears(int newYears)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventpatternPackage.SLIDING_TIME_INTERVAL__YEARS, oldYears, years));
	}
  ...
  public void setMonths(int newMonths)
  {
		...
		months = newMonths;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventpatternPackage.SLIDING_TIME_INTERVAL__MONTHS, oldMonths, months));
	}
  ...
  public void setWeeks(int newWeeks)
  {
		...
		weeks = newWeeks;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventpatternPackage.SLIDING_TIME_INTERVAL__WEEKS, oldWeeks, weeks));
	}
  ...
  public void setDays(int newDays)
  {
		...
		days = newDays;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventpatternPackage.SLIDING_TIME_INTERVAL__DAYS, oldDays, days));
	}
  ...
  public void setHours(int newHours)
  {
		...
		hours = newHours;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventpatternPackage.SLIDING_TIME_INTERVAL__HOURS, oldHours, hours));
	}
  ...
  public void setMinutes(int newMinutes)
  {
		...
		minutes = newMinutes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventpatternPackage.SLIDING_TIME_INTERVAL__MINUTES, oldMinutes, minutes));
	}
  ...
  public void setSeconds(int newSeconds)
  {
		...
		seconds = newSeconds;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventpatternPackage.SLIDING_TIME_INTERVAL__SECONDS, oldSeconds, seconds));
	}
  ...
  public void setMilliseconds(int newMilliseconds)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventpatternPackage.SLIDING_TIME_INTERVAL__MILLISECONDS, oldMilliseconds, milliseconds));
	}
