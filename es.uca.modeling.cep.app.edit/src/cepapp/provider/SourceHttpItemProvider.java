...
/**
 * This is the item provider adapter for a {@link cepapp.SourceHttp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SourceHttpItemProvider extends HttpItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SourceHttpItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SourceHttp"));
	}
	...
	public String getText(Object object) {
		MappingType labelValue = ((SourceHttp)object).getMappingType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_SourceHttp_type") :
			getString("_UI_SourceHttp_type") + " " + label;
	}
