...
/**
 * This is the item provider adapter for a {@link cepapp.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends SourceElementItemProvider {
	/**
	...
	protected void addTypeNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_typeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_typeName_feature", "_UI_Event_type"),
				 CepappPackage.Literals.EVENT__TYPE_NAME,
				 true,
				 false,
				 false,
	...
	protected void addImagePathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_imagePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_imagePath_feature", "_UI_Event_type"),
				 CepappPackage.Literals.EVENT__IMAGE_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CepappPackage.Literals.EVENT__EVENT_PROPERTIES);
		}
	...
	public String getText(Object object) {
		String label = ((Event)object).getTypeName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CepappPackage.Literals.EVENT__EVENT_PROPERTIES,
