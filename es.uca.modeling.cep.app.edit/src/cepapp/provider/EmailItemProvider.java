...
/**
 * This is the item provider adapter for a {@link cepapp.Email} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EmailItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Email_username_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Email_username_feature", "_UI_Email_type"),
				 CepappPackage.Literals.EMAIL__USERNAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CepappPackage.Literals.EMAIL__PASSWORD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CepappPackage.Literals.EMAIL__HOST,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Email)object).getUsername();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Email.class)) {
			case CepappPackage.EMAIL__USERNAME:
			case CepappPackage.EMAIL__PASSWORD:
			case CepappPackage.EMAIL__HOST:
