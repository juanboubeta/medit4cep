...
/**
 * This is the item provider adapter for a {@link cepapp.OutputFile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputFileItemProvider extends FileItemProvider {
	/**
	...
	protected void addPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutputFile_path_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutputFile_path_feature", "_UI_OutputFile_type"),
				 CepappPackage.Literals.OUTPUT_FILE__PATH,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		MappingType labelValue = ((OutputFile)object).getMappingType();
