...
/**
 * This is the item provider adapter for a {@link cepapp.SinkMongoDB} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SinkMongoDBItemProvider extends MongoDBItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SinkMongoDBItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SinkMongoDB"));
	}
	...
	public String getText(Object object) {
		String label = ((SinkMongoDB)object).getCollectionName();
		return label == null || label.length() == 0 ?
			getString("_UI_SinkMongoDB_type") :
			getString("_UI_SinkMongoDB_type") + " " + label;
	}
