...
/**
 * This is the item provider adapter for a {@link cepapp.InMemoryInput} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InMemoryInputItemProvider extends InMemoryItemProvider {
	/**
	 ...
	 * @generated
	 */
	public InMemoryInputItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns InMemoryInput.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InMemoryInput"));
	}
	...
	public String getText(Object object) {
		MappingType labelValue = ((InMemoryInput)object).getMappingType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_InMemoryInput_type") :
			getString("_UI_InMemoryInput_type") + " " + label;
	}
