...
public class CepappFactoryImpl extends EFactoryImpl implements CepappFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CepappPackage.SOURCE_EMAIL: return createSourceEmail();
			case CepappPackage.INPUT_FILE: return createInputFile();
			case CepappPackage.SOURCE_HTTP: return createSourceHttp();
			...
			case CepappPackage.SINK_EMAIL: return createSinkEmail();
			case CepappPackage.OUTPUT_FILE: return createOutputFile();
			case CepappPackage.SINK_MONGO_DB: return createSinkMongoDB();
			case CepappPackage.SINK_HTTP: return createSinkHttp();
	 ...
	 * @generated
	 */
	public SourceEmail createSourceEmail() {
		SourceEmailImpl sourceEmail = new SourceEmailImpl();
		return sourceEmail;
	}
	 ...
	 * @generated
	 */
	public SourceHttp createSourceHttp() {
		SourceHttpImpl sourceHttp = new SourceHttpImpl();
		return sourceHttp;
	}
	 ...
	 * @generated
	 */
	public SinkEmail createSinkEmail() {
		SinkEmailImpl sinkEmail = new SinkEmailImpl();
		return sinkEmail;
	}
	 ...
	 * @generated
	 */
	public SinkMongoDB createSinkMongoDB() {
		SinkMongoDBImpl sinkMongoDB = new SinkMongoDBImpl();
		return sinkMongoDB;
	}
	 ...
	 * @generated
	 */
	public SinkHttp createSinkHttp() {
		SinkHttpImpl sinkHttp = new SinkHttpImpl();
		return sinkHttp;
	}
